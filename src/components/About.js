        ...
        <div className=' flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 h-screen'>
          ...
          {/* text */}
            <motion.div 
                  ...
                  <h3 className='h3 mb-4'>I'm a Full Stack Developer with over 8+ years of experience</h3>
                    <p className=' mb-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis laboriosam eos illum, dolorum
                    </p>
                    {/* stats */}
